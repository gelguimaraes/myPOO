...
public class TelaCreateMensagem extends JFrame{
	...
	private TelaListaPessoas viewListPessoas;
	...
	public TelaCreateMensagem(JLabel nlblCxEntrada, JLabel nlblCxSaida) {
		...
		btnEnviarMensagem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					Pessoa destinatario = Fachada.emailDestinatario(inputDestinatario.getText());
		...
		btnProcurar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				viewListPessoas = new TelaListaPessoas(inputDestinatario);
	...
	public TelaListaPessoas getTelalistaPessoas() {
